...
import com.concordia.SOEN6461.util.calendarpanel.dragNdrop.CalendarPaneDropTargetListener;
...
public class CalendarPane extends JPanel
{
    ...
    public int addMealLabel(CalendarCache itemCache, String strMeal, int iXNextMeal)
    {
        ...
        if (!(component instanceof JUnderlinedLabel))
        {
            if (iXNextMeal == -1)
                iXNextMeal = 0;
            label = this.addIcon(null, null, insets.left + 1, insets.top + 1, null, null, CalendarConstants.NOT_DRAGGABLE, null);
